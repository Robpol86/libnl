...
def test_no_attrs(tcp_server):
    ...
    // 0 == nlh->nlmsg_seq
    // 0 == nlh->nlmsg_pid
    // 1423352334 == nlh->nlmsg_seq
    // 1423350947 == nlh->nlmsg_seq
    // Bytes: 16
    // EAAAAAAABQCjnNZUAAAAAA==
    """
    msg = nlmsg_alloc()
    nlh = nlmsg_hdr(msg)
    ...
    assert b'EAAAAAAABQCjnNZUAAAAAA==' == base64.b64encode(iov)
    assert b'EAAAAAAABQCjnNZUAAAAAA==' == base64.b64encode(tcp_server.data[0])
    nl_socket_free(sk)
